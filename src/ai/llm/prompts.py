...
3. **必须原样展示**以下数据表格（不要省略，直接输出 Markdown 表格）：
   - 【财务摘要/估值指标】
   - 【近期资金流向】
   - 【近10日行情】
   - 【十大股东】
...
### 🛑 逻辑一致性校验（必须严格检查）
- 若建议 **买入**：必须满足 **目标价 > 当前价 > 止损价**。禁止出现目标价低于止损价的逻辑错误。
- 若建议 **卖出**：必须满足 **目标价 < 当前价 < 止损价**。
- 若目标价与当前价倒挂，请检查是否应该给"卖出"评级，或者调整目标价。
